...
struct StoryBrain {
    ...
    func getChoice1Destination() -> Int {
        return stories[currentStoryIndex].choice1Destination
    }
    ...
    func getChoice2Destination() -> Int {
        return stories[currentStoryIndex].choice2Destination
    }
    
    mutating func nextStory(_ destination: Int)
    {
        self.currentStoryIndex = destination
